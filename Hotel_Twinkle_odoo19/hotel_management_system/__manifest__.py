...
##########################################################################
{
    ...
    "assets": {
        "web.assets_frontend": [
            ...
            # Migration v19 issues -> Duplicated payment Form public widget
            # "hotel_management_system/static/src/js/duplicate_payment_form.js"
        ],
        "web.assets_backend": [
        ...
        'website.website_builder_assets': [
            'hotel_management_system/static/src/website_builder/**/*',
        ],
    },
    "application": True,
    "installable": True,
