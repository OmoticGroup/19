...
class ThemeConfiguration(models.Model):
    ...
    #------- shop settings
    card_product_style = fields.Selection([('card_product_style_defualt','Card Product Style Defualt'),('card_product_style_1','Card Product Style 1'),('card_product_style_2','Card Product Style 2'),('card_product_style_3','Card Product Style 3'),('card_product_style_4','Card Product Style 4')],"Card Product Style", default='card_product_style_1')
