...
class WebsiteSaleBits(http.Controller):
    @http.route(['/product/get_quick_view_data'], type='jsonrpc', auth="public", website=True)
    ...
    @http.route(['/get/dialog/data'], type='jsonrpc', auth="public", website=True)
    ...
    @http.route(['/check/activity_menu'], type='jsonrpc', auth="user", website=True)
    ...
    @http.route(['/get/cart_notify'], type='jsonrpc', website=True, auth="public")
    ...
    @http.route('/get_mini_cart', auth='public', type="jsonrpc", website=True)
    ...
    @http.route('/as_clear_cart', type="jsonrpc", auth="public", website=True)
...
class WSVControllerBits(WebsiteSaleVariantController):
    @http.route('/website_sale/get_combination_info', type='jsonrpc', auth='public', methods=['POST'], website=True)
