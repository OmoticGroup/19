...
class HotelSnippet(http.Controller):
    ...
    @http.route(["/wk/get_hotels"], type="jsonrpc", auth="public", website=True, sitemap= False)
...
class WebsiteSale(WebsiteSale):
    ...
    @http.route('/order/advance_payment/modal_content', type='jsonrpc', auth='public', website=True, sitemap= False)
    ...
    @http.route('/order/advance_payment/check_hotel_advance_config', type='jsonrpc', auth='public', website=True, sitemap= False)
