...
publicWidget.registry.PaymentFormDuplicate = publicWidget.Widget.extend({
    selector: '#payment_iframe',
    ...
    init() {
        ...
        console.log("-----> Our Duplicate Payment Form Public Widget <-----");
    },
...
export default publicWidget.registry.PaymentFormDuplicate;
